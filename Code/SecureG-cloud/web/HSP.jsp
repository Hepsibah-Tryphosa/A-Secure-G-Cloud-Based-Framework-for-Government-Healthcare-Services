        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h3 class="mb-4">Healthcare Service Provider Login Here </h3>
                    <p class="mb-4">
                        
                        <form action="HSPLoginCheck" class="appointment-form ftco-animate">
			              ...
			              <input type="submit" value="Login" class="btn btn-secondary py-3 px-4">
                            ...
                            %>
                                                    ...
                                                    <p class="mb-0"><a href="HSPRegister.jsp" class="btn btn-secondary py-3 px-4">Healthcare Service Register</a></p>
		    				</div>
                        </form>
                    </p>
