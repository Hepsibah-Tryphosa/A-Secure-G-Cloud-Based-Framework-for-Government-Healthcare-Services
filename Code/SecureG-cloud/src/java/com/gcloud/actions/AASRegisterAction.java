 ...
 * @author Poojitha
 */
public class AASRegisterAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sqlQuery = "insert into aasregister(patientname,email,pswd,mobile,dob,gender,state,country,status,accesskey) values(?,?,?,?,?,?,?,?,?,?)";
            ...
            if (count > 0) {
                response.sendRedirect("AASRegister.jsp?msg=success");
            } else {
                response.sendRedirect("AASRegister.jsp?msg=failed");
            }
