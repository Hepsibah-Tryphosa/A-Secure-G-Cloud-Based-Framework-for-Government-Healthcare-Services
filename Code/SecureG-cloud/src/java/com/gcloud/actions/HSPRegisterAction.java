...
public class HSPRegisterAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sqlQuery = "insert into hspregister(patientname,email,pswd,mobile,dob,gender,state,country,status,accesskey,role) values(?,?,?,?,?,?,?,?,?,?,?)";
            ...
            if (count > 0) {
                response.sendRedirect("HSPRegister.jsp?msg=success");
            } else {
