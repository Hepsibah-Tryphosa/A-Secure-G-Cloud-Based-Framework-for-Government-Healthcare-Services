        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h3 class="mb-4">Authority Login Here </h3>
                    <p class="mb-4">
                        
                        <form action="AuthirityLoginCheck" class="appointment-form ftco-animate">
		        		
		    				<div class="">
			    				<div class="form-group">
			    					<input type="text" name="name" class="form-control" placeholder="Login ID" required="">
			    				</div>
			    				<div class="form-group">
