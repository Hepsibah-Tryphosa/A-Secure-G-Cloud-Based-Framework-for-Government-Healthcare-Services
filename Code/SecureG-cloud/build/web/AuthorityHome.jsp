...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="AuthorityHome.jsp"> G-Cloud-Based Framework </a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="Authorityhspdetails.jsp" class="nav-link"><span>HSP_Details</span></a></li>
                  <li class="nav-item"><a href="Authorityaasdetails.jsp" class="nav-link"><span>AAS_Details</span></a></li>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h3 class="mb-4"> Authority Login Successfully  </h3>
