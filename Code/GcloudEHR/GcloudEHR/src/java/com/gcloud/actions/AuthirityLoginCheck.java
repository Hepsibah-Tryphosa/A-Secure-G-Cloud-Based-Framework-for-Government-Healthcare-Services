...
public class AuthirityLoginCheck extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String authpswd = request.getParameter("pswd");
        if(authname.equalsIgnoreCase("Authority")&&authpswd.equalsIgnoreCase("Authority")){
        response.sendRedirect("AuthorityHome.jsp?msg=success");
        }else{
        response.sendRedirect("Authority.jsp?msg=filed");
        }
