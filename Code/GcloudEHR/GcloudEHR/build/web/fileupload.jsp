        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h3 class="mb-4">PHR fill Upload by Patient </h3>
                    <p class="mb-4">
                        
                    <form action="PatientFileUpload" method="post" class="appointment-form ftco-animate" enctype="multipart/form-data">
		        		
		    				<div class="">
			    				<div class="form-group">
                                                            <input type="name" name="filename" class="form-control" placeholder="File Name" required="">
                                                           </div>
			    				<div class="form-group">
                                                            <h4>
                                                                <input type="checkbox"   name="Hospital" value="Hospital" / >Hospital
                                                                <input type = "checkbox" name = "Doctor" value="Doctor" /> Doctor
                                                                <input type = "checkbox" name = "Surgen" value="Surgen"/> Surgen
                                                                <input type = "checkbox" name = "Insurance" value="Insurance" /> Insurance</h4>
                                                        </div>
                                                            <div class="form-group">
                                                              <input type="File" name="file" class="form-control" placeholder="Attribute" required="">
                                                            </div>
                                                    <div class="form-group">
