          ...
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h3 class="mb-4">Patient Login Here </h3>
                    ...
                    <form action="PatientLoginCheck" method="post" onsubmit="return validateForm()" class="appointment-form ftco-animate">
		        		
		    				<div class="">
			    				<div class="form-group">
                                                            <input type="email" name="email" class="form-control" placeholder="Login Email ID" required="">
			    				</div>
			    				<div class="form-group">
                                                            <input type="password" name="pswd" class="form-control" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z]).{8,}" title="Must contain at least one number and lowercase letter, and at least 8 or more characters" required="">
			    				</div>
                                                    <div class="form-group">
			              <input type="submit" value="Login" class="btn btn-secondary py-3 px-4">
			            </div>
                                                    <p class="mb-0"><a href="PatientRegister.jsp" class="btn btn-secondary py-3 px-4">Patient Register</a></p>
		    				</div>
                        </form>
                     <%
                                ...
                                if (msg != null && msg.equalsIgnoreCase("notexist")) {
                                    ...
                                    out.println("<font color='RED'>Email id and password not found please register first</font>");
                                }
